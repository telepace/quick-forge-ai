...
The language file structure is as follows (using [`en.ts`](https://github.com/telepace/quick-forge-ai/blob/main/src/i18n/en.ts) as an example):
...
export function SetupHero() {
  ...
  return (
    <div>
      <a href="https://github.com/telepace/quick-forge-ai">
        {t('badgeTitle')}
      </a>
